...
const unsigned long interval = 1500;  // 1.5 seconds
int caseNumber = 1;
int inputValue = 10; // First input value
...
// // Execute function
// result = get_next_holes_from_laserscan_non_filtered(angle, distance, lidar_height, caseNumber);
// if (result != 0.0) {
//   if (!isnan(result)) {
//     if (result != 0.0) {
//       // Print JSON output
...
//       // Toggle inputs and case numbers
//       if (caseNumber == 1) {
//         caseNumber = 2;
//         inputValue = 1;  // Second input value
//       } else {
//         caseNumber = 1;
//         inputValue = 2;  // First input value
//       }
//     }
//   }
// }
...
if (result != 0.0) {
  if (!isnan(result)) {
    if (result != 0.0) {
      ...
      json += "\": ";
      json += String(result, 2);  // 2 decimal places
      json += " }";
    ...
    //       distance_filted = get_next_holes_from_laserscan_non_filtered(angle, distance,lidar_height,1);
